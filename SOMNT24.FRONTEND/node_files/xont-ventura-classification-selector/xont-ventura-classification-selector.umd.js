(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/platform-browser/animations'), require('@angular/forms'), require('xont-ventura-services'), require('angular2-busy'), require('angular2-datatable'), require('@angular/http'), require('rxjs/Rx'), require('lodash')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/platform-browser/animations', '@angular/forms', 'xont-ventura-services', 'angular2-busy', 'angular2-datatable', '@angular/http', 'rxjs/Rx', 'lodash'], factory) :
	(factory((global['xont-ventura-classification-selector'] = {}),global.core,global.common,global.animations,global.forms,global.xontVenturaServices,global.angular2Busy,global.angular2Datatable,global.http,global.Rx,global._));
}(this, (function (exports,core,common,animations,forms,xontVenturaServices,angular2Busy,angular2Datatable,http,Rx,_) { 'use strict';
...
XontVenturaClassificationSelectorComponent.propDecorators = {
    ...
    'codeInputs': [{ type: core.ViewChildren, args: ['codeInput',] },],
    'descInputs': [{ type: core.ViewChildren, args: ['descInput',] },],
    'id': [{ type: core.Input },],
    'classificationType': [{ type: core.Input },],
    'taskCode': [{ type: core.Input },],
    'codeTextWidth': [{ type: core.Input },],
    'enableUserInput': [{ type: core.Input },],
    'descriptionTextWidth': [{ type: core.Input },],
    'labelWidth': [{ type: core.Input },],
    'activeStatus': [{ type: core.Input },],
    'allMandatory': [{ type: core.Input },],
    'lastLevelRequired': [{ type: core.Input },],
...
XontVenturaClassificationSelectorModule.decorators = [
    { type: core.NgModule, args: [{
                imports: [
                    common.CommonModule, forms.FormsModule, animations.BrowserAnimationsModule, angular2Busy.BusyModule, angular2Datatable.DataTableModule
                ],
                declarations: [
                ...
                providers: [xontVenturaServices.CommonService, XontVenturaCaptionTranslateService],
            },] },
];
/**
 * @nocollapse
...
exports.XontVenturaClassificationSelectorModule = XontVenturaClassificationSelectorModule;
exports.XontVenturaClassificationSelectorComponent = XontVenturaClassificationSelectorComponent;
