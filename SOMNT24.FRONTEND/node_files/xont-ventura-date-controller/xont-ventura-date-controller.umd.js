(function (global, factory) {
	...
	(factory((global['xont-ventura-date-controller'] = {}),global.core,global.forms,global.common));
...
var DateControllerComponent = (function () {
                    ...
                    providers: [
                        {
                            ...
                            useExisting: core.forwardRef(function () { return DateControllerComponent; }),
                            multi: true
                        },
                        {
    ...
    DateControllerComponent.propDecorators = {
        "id": [{ type: core.Input },],
        "validationFloatSide": [{ type: core.Input },],
        "enabled": [{ type: core.Input },],
        "required": [{ type: core.Input },],
        "width": [{ type: core.Input },],
        "allowPastDates": [{ type: core.Input },],
        "allowCurrentDate": [{ type: core.Input },],
        "allowFutureDates": [{ type: core.Input },],
        "msgPastDates": [{ type: core.Input },],
        "msgCurrentDate": [{ type: core.Input },],
        "msgFutureDates": [{ type: core.Input },],
        "msgInvalidDate": [{ type: core.Input },],
        "msgLessThan": [{ type: core.Input },],
        "msgGreaterThan": [{ type: core.Input },],
        "greaterThan": [{ type: core.Input },],
        "lessThan": [{ type: core.Input },],
        "onChange": [{ type: core.Output },],
        "calButton": [{ type: core.ViewChild, args: ['calButton',] },],
        "calText": [{ type: core.ViewChild, args: ['calText',] },],
    };
...
exports.XontVenturaDateControllerModule = XontVenturaDateControllerModule;
exports.DateControllerComponent = DateControllerComponent;
