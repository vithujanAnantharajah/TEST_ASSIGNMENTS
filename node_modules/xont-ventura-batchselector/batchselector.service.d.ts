...
export declare class BatchSelectorService {
    ...
    AutoSelectExpireBatch(territoryCode: string, warehouseCode: string, locationCode: string, productCode: string, requiredQty: number, uom: string, expireDate: Date): any;
    ...
    GetBatchSerials6(territoryCode: string, warehouseCode: string, locationCode: string, productCode: string, requiredQty: number, uom: string, expireDate: Date): any;
    GetBatchSerials7(territoryCode: string, warehouseCode: string, locationCode: string, productCode: string, requiredQty: number, uom: string, expireDate: Date, uom1: string, conversionFactor: number, reservedBatchSerials: ProductBatchSerial[], selectedBatchSerials: ProductBatchSerial[]): any;
    GetBatchSerials8(taskCode: string, territoryCode: string, warehouseCode: string, locationCode: string, productCode: string, requiredQty: number, uom: string, uom1: string, conversionFactor: number, reservedBatchSerials: ProductBatchSerial[], selectedBatchSerials: ProductBatchSerial[], checkExpiryDate: boolean, addAllocated: boolean): any;
    AutoSelect8(taskCode: string, territoryCode: string, warehouseCode: string, locationCode: string, productCode: string, requiredQty: number, uom: string, uom1: string, conversionFactor: number, reservedBatchSerials: ProductBatchSerial[], selectedBatchSerials: ProductBatchSerial[], checkExpiryDate: boolean, addAllocated: boolean): any;
