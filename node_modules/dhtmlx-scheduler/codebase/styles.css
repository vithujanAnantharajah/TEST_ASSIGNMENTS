...
.dhx_cal_navline {
    /*box-shadow: 0 1px 2px 2px #FFF;*/ /*V2001*/
}

.dhx_cal_header { /*V2001*/
    /*width:100% !important;
...
ef6c00
3F6813*/
.dhx_cal_event.dhx_shrt div {
    background-color: #FB6542 !important;
    color: white !important;
}

.dhx_cal_event.dhx_mdcl div {
    background-color: #bc87c6 !important;
    color: white !important;
}

.dhx_cal_event.dhx_anal div {
    background-color: #6bc690 !important;
    color: white !important;
}

.dhx_cal_event.dhx_csal div {
    background-color: #FFBB00 !important;
    color: white !important;
}

.dhx_cal_event.dhx_spcl div {
    background-color: #0097a7 !important;
    color: white !important;
}

.dhx_cal_event.dhx_own div {
    background-color: #ffc0cb !important;
    color: white !important;
}

.dhx_cal_event.dhx_refer_to div {
    background-color: #87ceeb !important;
    color: white !important;
}

.dhx_cal_event.dhx_by_other div {
    background-color: #e9e299 !important;
    color: white !important;
}
...
.dhx_cal_event_line.dhx_shrt {
    background-color: #FB6542 !important;
    color: white !important;
}

.dhx_cal_event_line.dhx_mdcl {
    background-color: #bc87c6 !important;
    color: white !important;
}

.dhx_cal_event_line.dhx_anal {
    background-color: #6bc690 !important;
    color: white !important;
}

.dhx_cal_event_line.dhx_csal {
    background-color: #FFBB00 !important;
    color: white !important;
}

.dhx_cal_event_line.dhx_spcl {
    background-color: #0097a7 !important;
    color: white !important;
}

.dhx_cal_event_line.dhx_own {
    background-color: #ffc0cb !important;
    color: white !important;
}

.dhx_cal_event_line.dhx_refer_to {
    background-color: #87ceeb !important;
    color: white !important;
}

.dhx_cal_event_line.dhx_by_other {
    background-color: #e9e299 !important;
    color: white !important;
}
...
.dhx_cal_event_clear.dhx_shrt {
    color: white !important;
    background-color: #FB6542;
}

.dhx_cal_event_clear.dhx_mdcl {
    color: white !important;
    background-color: #bc87c6;
}

.dhx_cal_event_clear.dhx_anal {
    color: white !important;
    background-color: #6bc690;
}

.dhx_cal_event_clear.dhx_csal {
    color: white !important;
    background-color: #FFBB00;
}

.dhx_cal_event_clear.dhx_spcl {
    color: white !important;
    background-color: #0097a7;
}


.dhx_cal_event_clear.dhx_own {
    color: white !important;
    background-color: #ffc0cb;
}

.dhx_cal_event_clear.dhx_refer_to {
    color: white !important;
    background-color: #87ceeb;
}

.dhx_cal_event_clear.dhx_by_other {
    color: white !important;
...
.dhx_cal_event_line, .dhx_cal_event_clear, .dhx_cal_event {
    font-size: 14px;
...
.dhx_scheduler_month .dhx_now_time, .dhx_now_time {
    border-left: none;
}
...
.leave_not_applied, .leave_not_applied:hover {
...
.dhx_matrix_scell .dhx_marked_timespan, .dhx_matrix_scell .dhx_marked_timespan {
...
.dhtmlXTooltip.tooltip {
    ...
    z-index: 99;
    margin-left: 0;
    border: 1px solid rgba(183, 162, 162, 0.54);
}

.dhx_matrix_line .blink-event {
    display: none !important;
}

.dhx_matrix_line .dhx_cell_holiday {
    /*border-right: 1px solid #CECECE;*/
    padding-left: 0px;
}

    .dhx_matrix_line .dhx_cell_holiday > span {
        display: none !important;
    }
