...
XontVenturaCollapsibleComponent.propDecorators = {
    ...
    'targetElementID': [{ type: Input, args: ['targetElementID',] },],
    'collapsedText': [{ type: Input, args: ['collapsedText',] },],
    'expandedText': [{ type: Input, args: ['expandedText',] },],
    'in': [{ type: Input, args: ['collapsed',] },],
...
export { XontVenturaCollapsibleModule, XontVenturaCollapsibleComponent };
