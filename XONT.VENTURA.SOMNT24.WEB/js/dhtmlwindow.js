...
var dhtmlwindow={
imagefiles:['images/blackdot.gif', '../images/close.gif', '', ''], //Path to 4 images used by script, in that order
...
setupdrag:function(e){
	...
	if (t.contentarea.datatype=="iframe"){ //if content of this window div is "iframe"
		//t.style.backgroundColor="#000000" //colorize and hide content div (while window is being dragged)
		t.contentarea.style.visibility="hidden"
	}
	document.onmousemove=d.getdistance //get distance travelled by mouse as it moves
	document.onmouseup=function(){
		if (t.contentarea.datatype=="iframe"){ //restore color and visibility of content div onmouseup
			//t.contentarea.style.backgroundColor="#000000"
